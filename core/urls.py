...
from .views import (
                        ...
                        LevarageView, NewsView, BankView, SubscribeView, PolicyView, QuestionView, ContactView,
...
urlpatterns = [
    ...
    #path('customer/', CustomerView.as_view(), name='customer_content'),
    #path('admin/', AdminView.as_view(), name='admin_content'),
